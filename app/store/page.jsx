    ...
    return (
        <section className='min-h-screen relative text-white'>
            <div className="w-[90%] flex mx-auto px-3 justify-center md:w-[80%] gap-4 py-1 items-center">
                ...
                <button className="flex gap-2 items-center text-white"><span>Search</span><GoSearch /></button>
            </div>
            <div className='m-5'>
            ...
            <div className="justify-start  mb-8 pb-5 mx-auto w-4/5 space-x-4 space-y-4 items-center flex flex-wrap text-white">
